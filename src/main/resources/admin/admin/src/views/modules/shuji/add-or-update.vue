               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="书籍编号" prop="shujiUuidNumber">
                       <el-input v-model="ruleForm.shujiUuidNumber"
                                 placeholder="书籍编号" clearable  :readonly="ro.shujiUuidNumber"></el-input>
                   </el-form-item>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="书籍名称" prop="shujiName">
                       <el-input v-model="ruleForm.shujiName"
                                 placeholder="书籍名称" clearable  :readonly="ro.shujiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="书籍作者" prop="shujiZuozhe">
                       <el-input v-model="ruleForm.shujiZuozhe"
                                 placeholder="书籍作者" clearable  :readonly="ro.shujiZuozhe"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出版社" prop="shujiChubanshe">
                       <el-input v-model="ruleForm.shujiChubanshe"
                                 placeholder="出版社" clearable  :readonly="ro.shujiChubanshe"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shujiPhoto" label="书籍照片" prop="shujiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.shujiPhoto?$base.url+ruleForm.shujiPhoto:''"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="书籍类型" prop="shujiTypes">
                        <el-select v-model="ruleForm.shujiTypes" :disabled="ro.shujiTypes" placeholder="请选择书籍类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="所在书架" prop="shujiaTypes">
                        <el-select v-model="ruleForm.shujiaTypes" :disabled="ro.shujiaTypes" placeholder="请选择所在书架">
                            <el-option
                                v-for="(item,index) in shujiaTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="详细地址" prop="shujiaAddress">
                       <el-input v-model="ruleForm.shujiaAddress"
                                 placeholder="详细地址" clearable  :readonly="ro.shujiaAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="书籍库存" prop="shujiKucunNumber">
                       <el-input v-model="ruleForm.shujiKucunNumber"
                                 placeholder="书籍库存" clearable  :readonly="ro.shujiKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.shujiContent"  label="书籍介绍" prop="shujiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shujiContent" label="书籍介绍" prop="shujiContent">
    ...
    export default {
        data() {
            return {
                ...
                userId:"",//当前登录人的id
                ro:{
                    shujiUuidNumber: false,
                    shujiName: false,
                    shujiZuozhe: false,
                    shujiChubanshe: false,
                    shujiPhoto: false,
                    shujiTypes: false,
                    shujiaTypes: false,
                    shujiaAddress: false,
                    shujiKucunNumber: false,
                    shujiClicknum: false,
                    shujiContent: false,
                    shujiDelete: false,
                },
                ruleForm: {
                    shujiUuidNumber: new Date().getTime(),
                    shujiName: '',
                    shujiZuozhe: '',
                    shujiChubanshe: '',
                    shujiPhoto: '',
                ...
                rules: {
                   ...
                   shujiPhoto: [
                              { required: true, message: '书籍照片不能为空', trigger: 'blur' },
                          ],
                   shujiTypes: [
                   ...
                   shujiaTypes: [
                              { required: true, message: '所在书架不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shujiKucunNumber: [
                              { required: true, message: '书籍库存不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shujiContent: [
                              { required: true, message: '书籍介绍不能为空', trigger: 'blur' },
                          ],
                   shujiDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shujia_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shujiaTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.shujiContent = _this.ruleForm.shujiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.shujiContent = this.ruleForm.shujiContent.replaceAll(this.$base.url,"");
                        this.$http({
