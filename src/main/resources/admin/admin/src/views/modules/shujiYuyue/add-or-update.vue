    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.shujiYuyueTime"  class="input" label="借阅时间" prop="shujiYuyueTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shujiYuyueTime" label="借阅时间" prop="shujiYuyueTime">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="借阅天数" prop="shujiYuyueNum">
                       <el-input v-model="ruleForm.shujiYuyueNum"
                                 placeholder="借阅天数" clearable  :readonly="ro.shujiYuyueNum"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="借阅天数" prop="shujiYuyueNum">
                           <el-input v-model="ruleForm.shujiYuyueNum"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="借阅状态" prop="shujiYuyueTypes">
                        <el-select v-model="ruleForm.shujiYuyueTypes" :disabled="ro.shujiYuyueTypes" placeholder="请选择借阅状态">
                            <el-option
                                v-for="(item,index) in shujiYuyueTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="借阅状态" prop="shujiYuyueValue">
                        <el-input v-model="ruleForm.shujiYuyueValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    shujiYuyueNum: false,
                    shujiYuyueTypes: false,
                    shujiYuyueDelete: false,
                    insertTime: false,
                },
                ruleForm: {
                    shujiId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shuji_yuyue_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shujiYuyueTypesOptions = data.data.list;
                    }
                });
