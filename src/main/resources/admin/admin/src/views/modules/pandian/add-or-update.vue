    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shujiId" name="shujiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="盘点数量" prop="pandianNum">
                       <el-input v-model="ruleForm.pandianNum"
                                 placeholder="盘点数量" clearable  :readonly="ro.pandianNum"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="盘点数量" prop="pandianNum">
                           <el-input v-model="ruleForm.pandianNum"
                                     placeholder="盘点数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.pandianContent"  label="备注" prop="pandianContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.pandianContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.pandianContent" label="备注" prop="pandianContent">
                            <span v-html="ruleForm.pandianContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.pandianContent = _this.ruleForm.pandianContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.pandianContent = this.ruleForm.pandianContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`pandian/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.pandianCrossAddOrUpdateFlag = false;
                                        this.parent.search();
