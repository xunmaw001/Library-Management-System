    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴纳金额" prop="fajinPrice">
                       <el-input v-model="ruleForm.fajinPrice"
                                 placeholder="缴纳金额" clearable  :readonly="ro.fajinPrice"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="缴纳金额" prop="fajinPrice">
                           <el-input v-model="ruleForm.fajinPrice"
                                     placeholder="缴纳金额" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.fajinContent"  label="缴纳原因" prop="fajinContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.fajinContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fajinContent" label="缴纳原因" prop="fajinContent">
                            <span v-html="ruleForm.fajinContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   fajinContent: [
                              { required: true, message: '缴纳原因不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.fajinContent = _this.ruleForm.fajinContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.fajinContent = this.ruleForm.fajinContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`fajin/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.fajinCrossAddOrUpdateFlag = false;
                                        this.parent.search();
