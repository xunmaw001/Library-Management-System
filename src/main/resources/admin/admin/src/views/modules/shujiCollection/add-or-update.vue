    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="shujiCollectionTypes">
                        <el-select v-model="ruleForm.shujiCollectionTypes" :disabled="ro.shujiCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in shujiCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="shujiCollectionValue">
                        <el-input v-model="ruleForm.shujiCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    shujiId: false,
                    yonghuId: false,
                    shujiCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    shujiId: '',
                    yonghuId: '',
                    shujiCollectionTypes: '',
                    insertTime: '',
                },
                shujiCollectionTypesOptions : [],
                shujiOptions : [],
                yonghuOptions : [],
                rules: {
                   shujiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shuji_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shujiCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shujiCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shujiCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
