...
//                            shujiEntity.setShujiZuozhe(data.get(0));                    //书籍作者 要改的
//                            shujiEntity.setShujiChubanshe(data.get(0));                    //出版社 要改的
//                            shujiEntity.setShujiPhoto("");//详情和图片
//                            shujiEntity.setShujiTypes(Integer.valueOf(data.get(0)));   //书籍类型 要改的
//                            shujiEntity.setShujiaTypes(Integer.valueOf(data.get(0)));   //所在书架 要改的
//                            shujiEntity.setShujiaAddress(data.get(0));                    //详细地址 要改的
