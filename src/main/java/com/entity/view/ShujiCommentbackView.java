...
public class ShujiCommentbackView extends ShujiCommentbackEntity implements Serializable {
	...
	public ShujiCommentbackView() {

	}

	public ShujiCommentbackView(ShujiCommentbackEntity shujiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, shujiCommentbackEntity);
