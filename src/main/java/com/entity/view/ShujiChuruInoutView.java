...
public class ShujiChuruInoutView extends ShujiChuruInoutEntity implements Serializable {
	...
	*/
	...
	public ShujiChuruInoutView() {

	}

	public ShujiChuruInoutView(ShujiChuruInoutEntity shujiChuruInoutEntity) {
		try {
			BeanUtils.copyProperties(this, shujiChuruInoutEntity);
	...
	*/
	...
	public String toString() {
		return "ShujiChuruInoutView{" +
			", shujiChuruInoutValue=" + shujiChuruInoutValue +
			"} " + super.toString();
	}
}
