 ...
 */
@TableName("fajin")
public class FajinEntity<T> implements Serializable {
     ...
     * 缴纳金额
     */
    @ColumnInfo(comment="缴纳金额",type="decimal(10,2)")
     ...
     * 缴纳原因
     */
    @ColumnInfo(comment="缴纳原因",type="text")
    ...
    public String toString() {
        return "Fajin{" +
            ", id=" + id +
            ", yonghuId=" + yonghuId +
            ", fajinPrice=" + fajinPrice +
            ", fajinContent=" + fajinContent +
